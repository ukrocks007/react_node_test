 ...
 * 
 * Manages the content display based on authentication state.
 * Ensures users are directed to login if not authenticated.
 */
const AppContent = () => {
  const { user } = useAuth();
  const isAuthenticated = !!user || !!localStorage.getItem("token");
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          {/* Landing routes - redirect to login if not authenticated */}
          <Route path="/" element={
            isAuthenticated ? <Navigate to="/user/dashboard" replace /> : <PublicDashboard />
          } />
